...
LDFLAGS += -s -w
LDFLAGS += -X "github.com/huanghj78/jepsenFuzz/pkg/test-infra/fixture.BuildTS=$(shell date -u '+%Y-%m-%d %I:%M:%S')"
LDFLAGS += -X "github.com/huanghj78/jepsenFuzz/pkg/test-infra/fixture.BuildHash=$(shell (git rev-parse --git-dir > /dev/null 2>&1 && git rev-parse HEAD) || echo 'NO-HASH')"
...
groupimports: install-goimports
	goimports -w -l -local github.com/huanghj78/jepsenFuzz .
