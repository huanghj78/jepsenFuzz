...
const goModuleTemplate = `module github.com/huanghj78/jepsenFuzz/testcase/{{ .CaseName }}

go 1.16

require (
	github.com/go-sql-driver/mysql v1.5.0
	github.com/huanghj78/jepsenFuzz v1.0.0
	github.com/huanghj78/jepsenFuzz/logsearch v1.0.0
)
